# Generated by Django 5.0.6 on 2024-10-15 12:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creater_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('attendance_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_manage_system.attendance')),
                ('student_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='student_manage_system.students')),
            ],
        ),
        migrations.CreateModel(
            name='Subjects',
        ...
        migrations.AddField(
            ...
            name='subject_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='student_manage_system.subjects'),
        ),
    ]
